...
export default function UserNav() {
  ...
  // Jika tidak ada user, tampilkan tombol Login (Desktop Default)
  if (!user) return <LoginTrigger mode="desktop-login" />;
  ...
  return (
    <>
      ...
      {/* DIALOG LOGOUT (Diluar Dropdown agar aman) */}
      ...
      <DropdownMenu open={isMenuOpen} onOpenChange={setIsMenuOpen}>
        <DropdownMenuTrigger asChild>
          ...
          >
            ...
            <span
              className={`absolute -top-0.5 -right-0.5 flex h-3 w-3 items-center justify-center rounded-full ring-2 ring-white z-10 ${
        ...
        >
          ...
          <div className="p-2">
            ...
            {/* --- FIX BUG DISINI: Hapus e.preventDefault() --- */}
            <DropdownMenuItem
